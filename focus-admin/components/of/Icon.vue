<template>
  <div class="icon-main flex-wrap flex-zy over-auto pd-12">
    <div v-for="(item, index) in allIcon" :key="index" class="hover-pointer mr-12 mb-12 flex-center-center" @click="chooseIcon(item)">
      <n-icon size="26" :component="loadIcon(item)" />
    </div>
  </div>
</template>
...
const loadIcon = (iconName: string): any => {
  return Icons[iconName as keyof typeof Icons];
};

// 返回所选
const chooseIcon = (item: string) => {
  emit('choose', item);
};
